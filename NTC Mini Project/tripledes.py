...
# Implementation of DES by Samyak Jain used for Triple DES
...
if __name__ == '__main__' : 
    ...
    # Encryption process - EDE
    E_Output0 = D.encrypt(k0, plaintext)
    E_Output1 = D.decrypt(k1, E_Output0)
    E_Output2 = D.encrypt(k2, E_Output1)
    ...
    print("Text after decryption = " + str(plaintext_1))
